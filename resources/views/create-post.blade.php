...
@section('content')
    <main class="w-screen h-screen flex justify-center items-center bg-white">
        <div class="max-w-7xl bg-gray-200 text-black">
            <form class="w-full p-4 rounded shadow-md" action="{{route('post.store')}}" method="post">
                @csrf
                <h1 class="text-xl font-bold md:text-2xl mb-4">
                    <a href="{{ route('post.list') }}"><span class="text-blue-800">Nusa</span> <span
                            class="text-blue-400">Post</span></a>
                </h1>
                <h2 class="text-xl mb-4 tracking-wider font-lighter text-black">Buat Postingan</h2>
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="content" name="content"
                            ...
                            placeholder="Tulis isi postingan Anda" required></textarea>
                    </div>
                </div>
